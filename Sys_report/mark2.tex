...
\hypersetup{
  ...
  pdfborder={0 0 0},
  pdftitle={Battery Analyzer: System Development Project Report},
...
All libraries and frameworks employed by Battery Analyzer are free and open source.
...
users to optimize the life of their phone’s batteries, Battery Analyzer ensures that users
...
Battery Analyzer prevents battery failure and improves longevity with actionable data on
